"use strict";(()=>{var e={};e.id=5245,e.ids=[5245],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},12494:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>f,patchFetch:()=>y,requestAsyncStorage:()=>m,routeModule:()=>d,serverHooks:()=>h,staticGenerationAsyncStorage:()=>g});var r={};n.r(r),n.d(r,{POST:()=>p,dynamic:()=>l});var a=n(49303),s=n(88716),i=n(60670),o=n(87070),c=n(61165),u=n(40740);let l="force-dynamic";async function p(e){if(!await (0,c.rc)())return o.NextResponse.json({error:"Unauthorized"},{status:401});if(!process.env.ANTHROPIC_API_KEY)return o.NextResponse.json({error:"AI not configured"},{status:503});let{description:t}=await e.json();if(!t?.trim())return o.NextResponse.json({error:"Description required"},{status:400});try{let e=await (0,u.JY)(t);return o.NextResponse.json(e)}catch(e){return console.error("Estimate error:",e),o.NextResponse.json({error:"Estimation failed"},{status:500})}}let d=new a.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/nutrition/estimate/route",pathname:"/api/nutrition/estimate",filename:"route",bundlePath:"app/api/nutrition/estimate/route"},resolvedPagePath:"C:\\Users\\Geric\\Desktop\\forc3\\src\\app\\api\\nutrition\\estimate\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:m,staticGenerationAsyncStorage:g,serverHooks:h}=d,f="/api/nutrition/estimate/route";function y(){return(0,i.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:g})}},40740:(e,t,n)=>{n.d(t,{JY:()=>m,O1:()=>g,nC:()=>d});var r=n(80213),a=n(20728);function s(){let e=process.env.ANTHROPIC_API_KEY;if(!e)throw Error("ANTHROPIC_API_KEY not set");return new r.ZP({apiKey:e})}async function i(e){return a._.profile.findUnique({where:{userId:e}})}async function o(e,t){let n=new Date;return n.setDate(n.getDate()-t),a._.workoutLog.findMany({where:{userId:e,startedAt:{gte:n},completedAt:{not:null}},include:{workout:{select:{name:!0}},exerciseLogs:{include:{exercise:{select:{name:!0}},sets:{orderBy:{setNumber:"asc"}}}}},orderBy:{startedAt:"desc"},take:10})}async function c(e,t){let n=new Date;return n.setDate(n.getDate()-t),a._.nutritionLog.findMany({where:{userId:e,date:{gte:n}},orderBy:{date:"desc"},take:30})}async function u(e){return a._.trainingPlan.findUnique({where:{userId:e},include:{workouts:{include:{exercises:{include:{exercise:{select:{name:!0,muscleGroups:!0}}}}}}}})}function l(e){return 0===e.length?"No workouts logged in this period.":e.slice(0,5).map(e=>{let t=e.exerciseLogs.reduce((e,t)=>e+t.sets.reduce((e,t)=>e+t.weight*t.reps,0),0),n=e.exerciseLogs.slice(0,3).map(e=>{let t=e.sets.reduce((e,t)=>t.weight>(e?.weight||0)?t:e,e.sets[0]);return t?`${e.exercise.name}: ${t.weight}\xd7${t.reps}`:""}).filter(Boolean).join(", ");return`${new Date(e.startedAt).toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}: ${e.workout?.name||"Workout"} | ${Math.round(t)} lbs | ${n}`}).join("\n")}async function p(e){let[t,n,r,a]=await Promise.all([i(e),o(e,14),c(e,7),u(e)]);return`You are FORC3 AI Coach — a world-class personal trainer and nutrition coach with PhD-level expertise in exercise science and sports nutrition.
...
5. If you notice concerning patterns, flag them proactively`}async function d(e,t){let n=s(),r=await a._.coachMessage.findMany({where:{userId:e},orderBy:{createdAt:"desc"},take:10});r.reverse();let i=await p(e),o=[...r.map(e=>({role:e.role,content:e.content})),{role:"user",content:t}],c=await n.messages.create({model:"claude-haiku-4-5-20251001",max_tokens:1024,system:i,messages:o}),u="text"===c.content[0].type?c.content[0].text:"";return await a._.coachMessage.createMany({data:[{userId:e,role:"user",content:t},{userId:e,role:"assistant",content:u}]}),u}async function m(e){let t=s(),n=await t.messages.create({model:"claude-haiku-4-5-20251001",max_tokens:256,messages:[{role:"user",content:`Estimate the nutrition for this food/meal: "${e}"
...
Be realistic. If it's a meal, estimate the whole thing. Round to whole numbers.`}]});return JSON.parse(("text"===n.content[0].type?n.content[0].text:"{}").replace(/```json\n?|\n?```/g,"").trim())}async function g(e,t,n){let r=s(),[a,c]=await Promise.all([i(e),o(e,7)]),u=l(c),p=await r.messages.create({model:"claude-haiku-4-5-20251001",max_tokens:256,messages:[{role:"user",content:`Generate 2-3 short, personalized coaching tips for today's workout.
...
Respond as JSON array only: ["tip 1", "tip 2", "tip 3"]`}]}),d=("text"===p.content[0].type?p.content[0].text:"[]").replace(/```json\n?|\n?```/g,"").trim();try{return JSON.parse(d)}catch{return["Focus on form today.","Push hard on your working sets.","Stay hydrated!"]}}},95456:(e,t,n)=>{n.d(t,{AX:()=>p,Gg:()=>l,Rf:()=>d,ed:()=>c});var r=n(86890),a=n(41463),s=n(71615);let i=new TextEncoder().encode(process.env.JWT_SECRET||process.env.NEXTAUTH_SECRET||"forc3-secret-key-change-in-production"),o="forc3_session";async function c(e){return await new r.N(e).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("30d").sign(i)}async function u(e){try{let{payload:t}=await (0,a._)(e,i);return t}catch{return null}}async function l(){let e=await (0,s.cookies)(),t=e.get(o)?.value;return t?u(t):null}function p(e){return{name:o,value:e,httpOnly:!0,secure:!0,sameSite:"lax",maxAge:2592e3,path:"/"}}function d(){return{name:o,value:"",httpOnly:!0,secure:!0,sameSite:"lax",maxAge:0,path:"/"}}},20728:(e,t,n)=>{n.d(t,{_:()=>a});let r=require("@prisma/client"),a=globalThis.prisma||new r.PrismaClient({log:["warn","error"]})},61165:(e,t,n)=>{n.d(t,{rc:()=>a});var r=n(95456);async function a(){let e=await (0,r.Gg)();return e?.userId??null}n(20728)}};var t=require("../../../../webpack-runtime.js");t.C(e);var n=e=>t(t.s=e),r=t.X(0,[8948,5972,3112,213],()=>n(12494));module.exports=r})();